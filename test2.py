...
if __name__ == "__main__":
    for seed in [90]:
        ...
        for i in range(len(thres)):
            ...
            optp.mode = 'work'
            optp.n = 1
            optp.bounds_alpha = [(0, 20)]
            optp.bounds_beta = [(0.2, 7.0)]
            ...
            de_p.popsize = 16
            de_p.seed = seed
            optimizer = glo.DifferentialEvolutionOptimizer(optp, de_p, result_path=f"results/final/cc{seed}.json", detailed=False, mode='work')
